            ...
            <el-col :span="18">
                    ...
                    <div class="drawBoard" v-show="this.boardShow">
                        <div>
                            <div id="board" class="canvas-layers">
                                <canvas id="drawBoard" width="1000" height="650" style="position: absolute"></canvas>
                                <canvas id="showBoard" width="1000" height="650" style="position: absolute"></canvas>
                            </div>
                        </div>
                        <!-- 工具栏 -->
                        <div class="canvastools">
                            ...
                            <div>
                                <button class="clearButton" @click="clearDraw()">
                                    清空白板
                                </button>
                            </div>
                        </div>
                ...
                <div class="gjlan">
                    <div v-if="this.perimit">
                        <el-button v-show="!this.myMIC" @click="pushMIC">开启麦克风</el-button>
                        <el-button v-show="this.myMIC" @click="stoppushMIC">关闭麦克风</el-button>
                        <el-button v-show="!this.myCamera" @click="pushCamera">
                            开启摄像头
                        </el-button>
                        <el-button v-show="this.myCamera" @click="stopPushCamera">
                            关闭摄像头
                        </el-button>
                        <el-button @click="closeHand">关闭举手</el-button>
                    </div>
                    <div v-else>
                        <el-button type="primary" @click="hand">举手</el-button>
                    </div>
                    <button @click="stop()" class="stopbtn">离开直播</button>
...
export default {
    ...
    created() {
        ...
        axios
            .post(
                "http://127.0.0.1:8000/showzhiboInfo/",
                { username: this.teacherid, myName: this.uid },
                {
                    headers: {
    ...
    methods: {
        ...
        startPlayMIC() {
            ...
            this.player2.on(    ZLMRTCClient.Events.WEBRTC_ON_CONNECTION_STATE_CHANGE,
                (state) => {
                    if (state == "failed") {
                        this.startPlayMIC();
                    }
        ...
        start() {
            this.startPlay(), this.startPlayCamera(), this.startPlayMIC();
        },
        stopdesk() {
            if (this.player) {
                this.player.close();
